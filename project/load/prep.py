...
def read_dataframe(filename: str):
    ...
    df = df.drop(columns=['Agency Code','Agency Name','Agency Type','City','State','Year','Month','Incident','Crime Type','Victim Count','Perpetrator Count','Record Source'])
...
def preprocess(df: pd.DataFrame):
    ...
    encoders_and_columns = {'Crime Solved':le_crime_solved, 
